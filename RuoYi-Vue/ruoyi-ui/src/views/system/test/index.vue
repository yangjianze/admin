<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="审核内容名称" prop="name">
        <el-input
          v-model="queryParams.name"
          placeholder="请输入审核内容名称"
          clearable
          size="small"
    ...
    <el-table v-loading="loading" :data="testList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="审核内容名称" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="审核内容名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入审核内容名称" />
        </el-form-item>
        <el-form-item label="分值" prop="score">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除测试编号为"' + names + '"的数据项？').then(function() {
